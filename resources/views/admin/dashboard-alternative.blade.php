...
@section('content')
    <div class="content container-fluid dashboard-height">
        ...
        <div class="row">
            ...
            @include('admin.partials.dashboard.cardOrder')
        </div>

        <div class="card mb-3 mb-lg-5">
            <div class="card-header card-header-content-between">
                <h4 class="card-header-title">@lang("Wallet Currency")</h4>

                <a class="btn btn-ghost-secondary btn-sm" href="{{ route("admin.txnSummary") }}">@lang("View All")</a>
            </div>
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end mt-1"
                                            ...
                                            <a class="dropdown-item addBalance" href="{{ route('admin.user.wallets',$user->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <p class="text-muted"><span class="text-secondary font-weight-bold">@lang('N.B'):</span>
                                    ...
                                    <a href="https://www.youtube.com/watch?v=JzPfMbG1vrE" target="_blank"><i
