                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.basic.control.update') }}" method="post">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="@lang("Site Title")" aria-label="@lang("Site Title")" autocomplete="off"
                                        ...
                                        <div class="tom-select-custom">
                                            <select
                                                ...
                                                @foreach(timezone_identifiers_list() as $key => $value)
                                                    <option
                                                        value="{{$value}}" {{  (old('time_zone',$basicControl->time_zone) == $value ? ' selected' : '') }}>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('time_zone')
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        <label for="baseCurrency" class="form-label">@lang('Base Currency')</label>
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select @error('base_currency') is-invalid @enderror"
                                                    id="baseCurrency" name="base_currency">
                                                @foreach($currencies as $currency)
                                                    <option value="{{ $currency->code }}"
                                                            data-symbol="{{ $currency->symbol_native }}" data-rate="{{ $currency->rate }}"
                                                        {{ old('base_currency', $basicControl->base_currency == $currency->code ? 'selected' : '') }}>
                                                        {{ __($currency->code) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                               ...
                                               id="currencySymbol" autocomplete="off"
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <label for="currencyRate" class="form-label">@lang('Currency Rate')</label>
                                        <input type="text" class="form-control @error('currency_rate') is-invalid @enderror"
                                               name="currency_rate"
                                               id="currencyRate"
                                               placeholder="Currency Rate"
                                               autocomplete="off"
                                               value="{{ old('currency_rate',$basicControl->currency_rate) }}">
                                        @error('currency_rate')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="@lang("Fraction Number")" aria-label="@lang("Fraction Number")"
                                               autocomplete="off"
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('Create a secure password using our generator tool.')</span>
                                                </div>
                                                <div class="col-auto"><label class="row form-check form-switch mb-3"
                                                                             for="strongPassword">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('Enable or Disable User Registration')</span>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('Debug log that are generated.')</span>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('Is active cron notification')</span>
                                                </div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('Enable Button formation currency positioning.')</span>
                                                </div>
                                                <div class="col-auto">
...
@push('script')
    <script>
        ...
        $(document).on('change', '#baseCurrency', function () {
            ...
            const currencyRate = selectedOption.data('rate');
            $('#currencySymbol').val(currencySymbol)
            $('#currencyRate').val(parseFloat(currencyRate))
        });
