...
@section('page_title',__('Mail All Users'))
@section('content')
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item">
                                <a class="breadcrumb-link" href="{{ route('admin.dashboard') }}">@lang('Dashboard')</a></li>
                            <li class="breadcrumb-item">@lang('User Management')</li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('Mail To Users')</li>
                        </ol>
                    </nav>
                </div>
            </div>
