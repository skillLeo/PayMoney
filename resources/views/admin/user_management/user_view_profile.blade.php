            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card mb-3 mb-lg-5">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled list-py-2 text-dark mb-0">
                                    ...
                                    <li>
                                        <i class="bi bi-wallet dropdown-item-icon"></i> {{ currencyPositionCalc($item->balance,$item->currency) }}
                                    </li>
                                    @endforeach
                        ...
                        <div class="card mb-3 mb-lg-5">
                            <div class="card-header card-header-content-between">
                                <h4 class="card-header-title">@lang('Assigned Bank Account')</h4>
                                <a href="{{ route('admin.user.edit', $user->id) }}#assignedBankAccountSection" class="btn btn-white btn-sm">
                                    <i class="bi-bank me-1"></i>@lang('Manage')
                                </a>
                            </div>
                            ...
                            <div class="card-body">
                                @if($bankAccount)
                                    <ul class="list-unstyled list-py-2 text-dark mb-0">
                                        <li><span class="card-subtitle">@lang('IBAN')</span><div>{{ $bankAccount->iban }}</div></li>
                                        <li><span class="card-subtitle">@lang('Bank Name')</span><div>{{ $bankAccount->bank_name }}</div></li>
                                        <li><span class="card-subtitle">@lang('Account Holder')</span><div>{{ $bankAccount->account_holder_name ?: __('N/A') }}</div></li>
                                        <li><span class="card-subtitle">@lang('Currency')</span><div>{{ $bankAccount->currency_code ?: __('N/A') }}</div></li>
                                        <li><span class="card-subtitle">@lang('SWIFT / BIC')</span><div>{{ $bankAccount->swift_bic ?: __('N/A') }}</div></li>
                                        <li><span class="card-subtitle">@lang('Pool Status')</span><div>{{ optional($bankAccount->pool)->status == 1 ? __('Active') : __('Unavailable') }}</div></li>
                                        <li><span class="card-subtitle">@lang('Assigned At')</span><div>{{ $bankAccount->assigned_at ? dateTime($bankAccount->assigned_at) : __('N/A') }}</div></li>
                                    </ul>
                                @else
                                    <p class="mb-0 text-muted">@lang('No assigned bank account has been allocated to this user yet. Use the edit profile screen to assign one from the pool.')</p>
                                @endif
                            </div>
                        </div>
