                ...
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="{{ route('admin.users') }}">@lang('User Management')</a></li>
        ...
        <div class="row">
                ...
                <div class="navbar-expand-lg navbar-vertical mb-3 mb-lg-5">
                    ...
                    <div id="navbarVerticalNavMenu" class="collapse navbar-collapse">
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#assignedBankAccountSection">
                                    <i class="bi-bank nav-icon"></i> @lang('Assigned Bank Account')
                                </a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-lg-9">
                <div class="d-grid gap-3 gap-lg-5">
                                            ...
                                            <select class="js-select form-select countryChange" id="locationLabel" name="country">
                                                @forelse($allCountry as $country)
                                                    <option value="{{ $country['name'] }}"
                                                            ...
                                                            {{ $country['code'] == $user->country_code ? 'selected' : '' }}
                    ...
                    @include('admin.user_management.components.assigned_bank_account_section')
