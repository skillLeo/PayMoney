                    ...
                    <div class="text-center">
                        ...
                        <div class="mb-4">
                            ...
                            <p>@lang("New") <span
                                ...
                                created.")</p>
                            @if($bankAccount)
                                <p class="text-muted mb-0">@lang('Assigned bank account:') <span class="fw-semibold text-dark">{{ $bankAccount->iban }}</span></p>
                            @else
                                <p class="text-warning mb-0">@lang('No IBAN was auto-assigned from the pool. You can assign one from the user edit screen.')</p>
                            @endif
                        </div>
