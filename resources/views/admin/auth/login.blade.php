    ...
    <div class="card card-lg mt-lg-5">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.login.submit') }}" class="js-validate needs-validation"
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-merge" data-hs-validation-validate-class>
                        <input type="password"
                               ...
                               name="password" value="{{old('password','admin')}}" id="signupSrPassword" placeholder="Enter Password"
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary btn-lg" id="submitBtn">@lang('Sign in')</button>
                </div>
            </form>
        </div>
    </div>
