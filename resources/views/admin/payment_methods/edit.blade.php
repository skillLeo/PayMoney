                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.payment.methods') }}" class="btn btn-info float-end" ><i class="bi bi-arrow-left"></i> @lang('Back')</a>
                                                        ...
                                                        <td>
                                                            <div class="mb-1">
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value="{{ old("receivable_currencies.$i.currency_symbol",  $method->receivable_currencies[$i]->currency_symbol ?? '') }}"
                                                                       autocomplete="off">
    ...
    <div class="modal fade" id="autoUpdateCurrencyModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.payment.method.auto.update', $method->id) }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <span>@lang("Do you want to") <span>{{ __($method->name) }}</span> @lang("currency rate auto update?")</span>
                    </div>
