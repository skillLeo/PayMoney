                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h3 class="card-title mt-2">@lang('Add Manual Gateway')</h3>
                            <a href="{{ route('admin.deposit.manual.index') }}" class="btn btn-info float-end" >
                                <i class="bi bi-arrow-left"></i> @lang('Back')</a>
                            ...
                            <form action="{{route('admin.deposit.manual.store')}}" method="post"
                                        ...
                                        <span class="col-4 col-sm-9 ms-0 ">
                                         ...
                                         <input type='hidden' value='0' name='status'>
                                            <input class="form-check-input @error('status') is-invalid @enderror"
                                                   ...
                                                   value="1">
                                            <label class="form-check-label text-center" for="ManualStatusSwitch"></label>
                                        </span>
                                            @error('manual_status')
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <textarea id="summernote" id="noteLabel" name="note">
                                            {{ old("note") }}
                                        </textarea>
                                        @error('note')
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive position-relative">
                                        <table
                                            class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" id="supported_currency_table">
                                            <thead class="thead-light">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-1">
                                                        <input type="text"
                                                               ...
                                                               autocomplete="off" value="{{ old("receivable_currencies.$i.fixed_charge") }}">
                                                        <span
                                                            class="input-group-text set-currency">{{ old("receivable_currencies.$i.currency") }}</span>
