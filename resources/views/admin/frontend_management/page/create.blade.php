                ...
                <div class="col-sm">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Create Page")</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="page_content" id="summernote"
                                                  rows="20">{{ old("page_content") }}</textarea>
                                        @error("page_content")
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <span class="col-8 col-sm-9 ms-0">
                                      <span class="text-dark">@lang("Breadcrumb Status")
                                          <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                             ...
                                             data-bs-original-title="@lang("Enable breadcrumb image for this page")"></i></span>
                                    </span>
