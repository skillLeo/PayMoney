                ...
                <div class="col-sm">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="{{ route('admin.manage.content',$content) }}">@lang('Manage Content')</a></li>
                                                ...
                                                <div class="row">
                                                    @if($type == "text")
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label" for="@lang($name)">@lang(stringToTitle($name))</label>
                                                    ...
                                                    @if($type == "textarea")
                                                        <div class="col-md-12 mb-4">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name="{{ $name }}[{{ $language->id }}]">
                                                                 {{ old($name.'.'.$language->id, isset($multipleContentData[$language->id]) ? @$multipleContentData[$language->id][0]->description->{$name} : '') }}
                                                            </textarea>
                                                            @error($name.'.'.$language->id)
                                                            <span class="invalid-feedback d-block">{{ $message }}</span>
                                                            @enderror
                                                    ...
                                                    @if($type == "file" && $language->default_status == 1)
                                                        <div class="col-md-4">
                                                            <label class="form-check form-check-dashed"
                                                                   for="logoUploader{{$name}}" id="content_img{{$name}}">
                                                            ...
                                                            @if(config("contents.$content.single.size.image"))
                                                                <span
                                                                    class="text-muted d-block">{{trans('Image size should be')}} {{config("contents.$content.single.size.image")}} {{trans('px')}}</span>
                                                            @elseif(config("contents.$content.multiple.size.image"))
                                                                <span
                                                                    class="text-muted d-block">{{trans('Image size should be')}} {{config("contents.$content.multiple.size.image")}} {{trans('px')}}</span>
                                                            @endif
                                                        </div>
                                                    @endif
                                                </div>
