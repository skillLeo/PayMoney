            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="{{trans('Search Service')}}"
                               aria-label="datatableSearch" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    <div class="d-flex flex-wrap ">
                        <a href="{{route('admin.service.create')}}" class="btn btn-sm btn-primary me-2">
                            @lang('Add New')
                        </a>
                    </div>
                </div>
                ...
                <table id="datatable"
                   ...
                   "pagination": "datatablePagination"
                    ...
                    <tr>
                        ...
                        <th class="table-column-ps-0">@lang('Service Name')</th>
                        <th>@lang('Status')</th>
                        <th>@lang('Action')</th>
                    </tr>
                    </thead>
        ...
        <div class="modal fade" id="all_inactive" role="dialog" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>@lang("Are you really want to Inactive the services?")</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-white" data-bs-dismiss="modal">@lang('Close')</button>
                        <form action="" method="post">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="" method="post">
                        @csrf
                        <div class="modal-body">
                            @lang('"Do you want to delete selected data?')
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-white" data-bs-dismiss="modal">@lang('Close')</button>
    ...
    <script>
        ...
        $(document).on('click', '.active-yes', function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.service.active.multiple') }}",
                data: {strIds: strIds},
                datatType: 'json',
                type: "post",
                success: function (data) {
        ...
        $(document).on('click', '.inactive-yes', function (e) {
            ...
            $.ajax({
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                url: "{{ route('admin.service.inactive.multiple') }}",
                data: {strIds: strIds},
                datatType: 'json',
                type: "post",
                success: function (data) {
