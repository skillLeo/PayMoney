...
@section('page_title', __('Add Country State'))
@section('content')
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h2 class="card-title h4 mt-2">@lang('Add New State for '.$country->name)</h2>
                            <a href="{{route('admin.countryState',$country)}}" class="btn btn-sm btn-info">
                                    ...
                                    <div class="col-md-6">
                                        <label class="row form-check form-switch mt-3" for="state_status">
                                            ...
                                            <input class="form-check-input @error('status') is-invalid @enderror"
                                                   type="checkbox"
                                                   name="status" id="stateStatus" value="1" checked>
