            ...
            <div class="d-grid gap-3 gap-lg-5">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h2 class="card-title h4 mt-2">@lang('Edit Service')</h2>
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.service.update',$service)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4 d-flex align-items-center">
                                ...
                                <div class="col-md-6">
                                    <label class="row form-check form-switch mt-3" for="status">
                                        ...
                                        <span class="col-2 col-sm-3 text-end">
                                            ...
                                            <input class="form-check-input @error('status') is-invalid @enderror" type="checkbox"
                                                   name="status" id="status" value="1" {{ old('status', $service->status) == 1 ? 'checked' : '' }}>
