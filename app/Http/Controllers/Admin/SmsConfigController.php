    ...
    public function smsConfigUpdate(Request $request, $method)
    {
        ...
        try {
            $env = [
                ...
                'TWILIO_SID' => $request->twilio_account_sid ?? $smsControlMethod['twilio']['twilio_account_sid']['value'],
                ...
                'TWILIO_NUMBER' => $request->twilio_phone_number ?? $smsControlMethod['twilio']['twilio_phone_number']['value'],
